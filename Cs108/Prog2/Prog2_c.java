...
public class Prog2_c {
	public static void main(String[] args) {
		...
		util.random2D(arrList); // envoke method to randomize each element of 2D Array
		util.transpose(arrList); // envoke method to transpose rows and columns and print the array
		scan.close();
	}
}
