...
public class Prog2_b {
	public static void main(String[] args) {
		...
		util.randomArray(arr1);  // envoke method to fill first array  with random numbers
		util.randomArray(arr2);  // envoke method to fill second array with random numbers
			System.out.println("arr1\n");
		util.printArray(arr1); // envoke method to print first array elements
		System.out.println();
			System.out.println("arr2\n");
			util.printArray(arr1);// envoke method to print second array elements
		System.out.print("\n");

		util.dotProduct(arr1, arr2);
		scan.close();
