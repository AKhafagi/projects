...
public class SortDriver {
	...
	private void heapSortTests(Integer[] toSort, Comparator<Integer> comp) {
		...
		myLog.info("Sorting an already Sorted array of size " + toSort.length + " using heap sort took " + duration
				+ " mili seconds.");
		myLog.info(print(toSort));

		myLog.info("running Heap Sort on reverse sorted array");
		reverseArray(toSort);
		myLog.info(print(toSort));
		startTime = System.currentTimeMillis();
		Sorters.heapSort(toSort, comp);
		endTime = System.currentTimeMillis();
		duration = ((endTime - startTime));
		myLog.info("Sorting an reverse Sorted array of size " + toSort.length + " using heap sort took " + duration
				+ " mili seconds.");
		myLog.info(print(toSort));
		...
		endTime = System.currentTimeMillis();
		duration = ((endTime - startTime));
		myLog.info("Sorting an unsorted array of size " + toSort.length + " using heap sort took " + duration
				+ " mili seconds.");
		myLog.info(print(toSort));
	...
	private void mergeSortTests(Integer[] toSort2, Comparator<Integer> comp2) {
		...
		endTime = System.currentTimeMillis();
		duration = ((endTime - startTime));
		myLog.info("Sorting an already Sorted array of size " + toSort.length + " using merge sort took " + duration
				+ " mili seconds.");
		myLog.info(print(toSort));
		shuffle(toSort, toSort.length / 2);
		myLog.info(print(toSort));

		myLog.info("running Merge Sort on reverse sorted array");
		reverseArray(toSort);
		myLog.info(print(toSort));
		startTime = System.currentTimeMillis();
		Sorters.mergeSort(toSort, comp);
		endTime = System.currentTimeMillis();
		duration = ((endTime - startTime));
		myLog.info("Sorting an reverse Sorted array of size " + toSort.length + " using merge sort took " + duration
				+ " mili seconds.");
		myLog.info(print(toSort));
		...
		endTime = System.currentTimeMillis();
		duration = ((endTime - startTime));
		myLog.info("Sorting an unsorted array of size " + toSort.length + " using merge sort took " + duration
				+ " mili seconds.");
		myLog.info(print(toSort));
	...
	private void quickSortTests(Integer[] toSort2, Comparator<Integer> comp2) {
		...
		endTime = System.currentTimeMillis();
		duration = ((endTime - startTime));
		myLog.info("Sorting an already Sorted array of size " + toSort.length + " using quick sort took " + duration
				+ " mili seconds.");
		myLog.info(print(toSort));

		myLog.info("running quick Sort on reverse sorted array");
		reverseArray(toSort);
		myLog.info(print(toSort));
		startTime = System.currentTimeMillis();
		Sorters.quickSort(toSort, comp);
		endTime = System.currentTimeMillis();
		duration = ((endTime - startTime));
		myLog.info("Sorting an reverse Sorted array of size " + toSort.length + " using quick sort took " + duration
				+ " mili seconds.");
		myLog.info(print(toSort));
		...
		endTime = System.currentTimeMillis();
		duration = ((endTime - startTime));
		myLog.info("Sorting an unsorted array of size " + toSort.length + " using quick sort took " + duration
				+ " mili seconds.");
		myLog.info(print(toSort));
	...
	private void shellSortTests(Integer[] toSort2, Comparator<Integer> comp2) {
		...
		endTime = System.currentTimeMillis();
		duration = ((endTime - startTime));
		myLog.info("Sorting an already sorted array of size " + toSort.length + " using shell sort took " + duration
				+ " mili seconds");
		myLog.info(print(toSort));

		myLog.info("running shell Sort on reverse sorted array");
		reverseArray(toSort);
		myLog.info(print(toSort));
		startTime = System.currentTimeMillis();
		Sorters.mergeSort(toSort, comp);
		endTime = System.currentTimeMillis();
		duration = ((endTime - startTime));
		myLog.info("Sorting an reverse Sorted array of size " + toSort.length + " using shell sort took " + duration
				+ " mili seconds.");
		myLog.info(print(toSort));
		...
		endTime = System.currentTimeMillis();
		duration = ((endTime - startTime));
		myLog.info("Sorting an unsorted array of size " + toSort.length + " using shell sort took " + duration
				+ " mili seconds");
		myLog.info(print(toSort));
