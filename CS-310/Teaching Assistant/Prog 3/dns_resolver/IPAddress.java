...
public class IPAddress implements Comparable<IPAddress> {
	...
	public int compareTo(IPAddress i) {
		if (((Integer) this.network).compareTo(i.network) != 0)
			return ((Integer) this.network).compareTo(i.network);
		if (((Integer) this.subnet).compareTo(i.subnet) != 0)
			return ((Integer) this.subnet).compareTo(i.subnet);		
		if (((Integer) this.subnet2).compareTo(i.subnet2) != 0)
			return ((Integer) this.subnet2).compareTo(i.subnet2);

		return ((Integer) this.host).compareTo(i.host);
	}
}